    ...
    <div className="py-16 sm:px-2 lg:relative lg:py-20 lg:px-0">
      <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-y-16 gap-x-8 px-4 lg:max-w-8xl lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
        <div className="relative z-10 md:text-center lg:text-left">
          <img
            alt=""
            src="/hamburgers/images/blur_cyan.png"
            width={530}
            height={530}
          ...
          <div className="relative">
            ...
            <p className="mt-3 text-2xl tracking-tight text-slate-400">
              Lightweight, zero-dependency, animated hamburger menus built on
              top of Tailwind CSS.
            </p>
        ...
        <div className="relative lg:static xl:pl-10">
          ...
          <div className="relative">
            ...
            <img
              alt=""
              src="/hamburgers/images/blur_indigo.png"
              width={567}
              height={567}
              decoding="async"
              data-nimg={1}
                  ...
                  <pre className="prism-code language-javascript flex overflow-x-auto pb-6">
                    <code className="px-4">
                      <div className="token-line">
                        <span className="token tag">{`<div class="tham tham-e-squeeze tham-w-6">`}</span>
                      </div>
                      <div className="token-line">
